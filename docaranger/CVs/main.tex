\documentclass[verylight]{hipstercv}
...
\header
  ...
  {\bgupper{headerfontbox}{headerfontboxfont}{\bfseries\Huge Guillaume THÉMÈZE}}
  {\bg{headerfontbox}{headerfontboxfont}{\large Doctorant en Physique Quantique}}
  {jack.jpg}
  %{headerblue}
  {gray}
  {3.5cm}
...
\begin{paracol}{2}
\hbadness=5000
\switchcolumn[0] % colonne gauche forcée
...
\begin{tabular}{ll}
\faMale         & Guillaume THÉMÈZE \\
\faGlobe        & Nationality: French  \\
\faBirthdayCake & 1997 \\
\faMapMarker    & France (Réunion Irland) \\
\end{tabular}
...
\textbf{English} & B1 & \pictofraction{\faCircle}{cvpurple}{2}{black!30}{1}{\tiny}
\end{tabular}
\end{minipage}
...
%\bubblediagram{{
%     \textbf{Curiosity} \\\textbf{\&} \\\textbf{Creativity}},
%     Hiking,
%    Paragliding,
%    {Drawing \\ Portraits},
%    {Drone \\ Video},
