...
\def\listetrais{-12 , -11, -10, -9 , -8 , -7 ,  -6 , -5, -4, -2 , -1, 0 ,  1, 2, 4 , 5 , 6 , 7 , 8 , 9 , 10 , 11, 12 }
...
%		\ifnum\r=0
%			\draw [color = gray  ]
%				( \r  , -0.3 ) edge [thick,line width=0.5ex] node [pos=-0.5 ]{\large $\theta_a$ }	( \r  , 0.3 )
%			;
...
%		\else\ifnum\r>0
%			\draw [color = gray  ]
%				( \r  , -0.3 ) edge [thick,line width=0.5ex] node [pos=-0.5 ]{\large$\theta_{a + \r}$ }	( \r  , 0.3 )
...
\begin{scope}
	...
	\begin{scope}[shift={(-10.5,10)},rotate=0,opacity=1,color=black]
	...
	\begin{scope}[shift={(-0,0)},rotate=0,opacity=1,color=black]
		...
		\filldraw [line width=0.5ex , color = \colorSix ,outer color=\colorSix,inner color=\colorSix ] (0.5 , 0.5) circle (4pt); 
		\node[anchor=west, font=\bfseries] at (0.7, 0.5) {\color{\colorSix}\large : quasi-particule};
		
		\filldraw [line width=-0.5ex , color = \colorSix ,outer color=\colorTwo,inner color=\colorTwo ] (0.5 , -0.5) circle (4pt); 
		\node[anchor=west, font=\bfseries] at (0.7, -0.5) {\color{\colorSix}\large : hole} ;
	\end{scope}
	...
	\begin{scope}[shift={(14.5,0)},rotate=0,opacity=1,color=black]	
		...
		\node[anchor=west] at (0.5, 0) {\color{\colorFour}\large $\rho_s = \rho + \rho_h $ };\node[anchor=west, font=\bfseries] at (2.5, 0) {\color{\colorFour}\large : density of states};
