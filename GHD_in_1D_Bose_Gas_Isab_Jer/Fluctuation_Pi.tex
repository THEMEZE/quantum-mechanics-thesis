...
\newcommand{\operator}[1]{\hat{\mathbf{#1}}} % pour les operaeur vecteur 
...
% Définir une nouvelle commande pour le vecteur avec flèche et gras
\newcommand{\vect}[1]{\mathbf{\overrightarrow{#1}}}
