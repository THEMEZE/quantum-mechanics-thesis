...
\newcommand{\Axetheta}[1][$\theta$]{
	\draw
		(-10, 0 ) edge [thick,line width=0.8ex,->,>=Triangle , color = \colorOne ]node [pos=1.01,right]{\huge #1 } ( 10  , 0 )
	;
}
			...
			\begin{tikzpicture}[transform canvas={scale=1}] 
				\begin{scope}
        			...
        			\draw[line width=1.8ex , color = \colorFour] 
        				(-0.3, 5 ) edge [thick,line width=0.8ex,, color = \colorOne ]node [pos=-0.01, left  ]{\huge $56$ } ( 0.3  , 5 )	
        				(-0.3, 0 ) edge [thick,line width=0.8ex,, color = \colorOne ]node [pos=-0.01, below left ]{\huge $0$ } ( 0.3  , 0 )	
        			;	
		...
		\node at (-13,0) [circle, rotate = 90 ] {
			\begin{tikzpicture}[transform canvas={scale=1}] 
				\begin{scope}
    				...
    				\draw[line width=1.8ex , color = \colorFour] 
    					(-0.3, 5 ) edge [thick,line width=0.8ex, color = \colorOne ]node [pos=-0.01, left  ]{\huge $1$ } ( 0.3  , 5 )	
    					(-0.3, 0 ) edge [thick,line width=0.8ex,, color = \colorOne ]node [pos=-0.01, below left ]{\huge $0$ } ( 0.3  , 0 )	
    					;	
		...
		\node at (13,0) [circle,   rotate = 90 , yscale = 1   ] {
			\begin{tikzpicture}[transform canvas={scale=1} ] 
				\begin{scope}
    				...
    				\draw[line width=1.8ex , color = \colorFour] 
    					(-0.3, -5 ) edge [thick,line width=0.8ex, color = \colorOne ]node [pos=-0.01, left  ]{\huge $1$ } ( 0.3  , -5 )	
    					(-0.3, 0 ) edge [thick,line width=0.8ex,, color = \colorOne ]node [pos=-0.01, above left ]{\huge $0$ } ( 0.3  , 0 )	
    					;			
				\end{scope}	
				
				\draw
					(-10, 0 ) edge [thick,line width=0.8ex,->,>=Triangle , color = \colorOne ]node [pos=1.01,right]{\huge $\theta ~ (\mu m / {ms}) $ } ( 10  , 0 )
					(0, 1 ) edge [thick,line width=0.8ex,->,>=Triangle , color = \colorOne ]node [pos=1.01,left  ]{\huge $\nu ( x > 0 ) $ } ( 0  , -6 )
				;	
				%\Axesdistribution[$\theta ~ (\mu m / {ms}) $]{$\nu ( x > 0 ) $}		
			\end{tikzpicture}
			...
			\begin{tikzpicture}[transform canvas={scale=1} ] 
				...
				\draw
    				(2, 0.2) edge[line width=1.8ex, color=\colorOne] 
        				node[pos=1.1, below]{ \color{\colorOne}\huge $\theta(s)$} (2, -0.2);		
				\Axesdistribution[$\theta ~ (\mu m/ms)$]{$\nu ( x(s) ) $}
	...
	\begin{tikzpicture}[transform canvas={scale=1}] 
		...
		\node at (0,13) [circle, ] {
			\begin{tikzpicture}[transform canvas={scale=1}] 
				...
				\draw[yshift = - 12]
					(0.1 , 0 )edge[line width=0.8ex, color=\colorOne , >-<, > = stealth,] node [pos = 0.5 , below]{\huge $\ell$}  ( 0.9 , 0) 	
				;
		...
		\node at (-13,0) [circle,   rotate = 90 , xscale = 1   ] {
			\begin{tikzpicture}[transform canvas={scale=1} ] 
				\begin{scope}
    				...
    				\draw[opacity = 1 , line width=1.8ex , dashed , color = \colorSix , fill = none ] plot[] file {data/rho_coupure_2_30.table};	
    				
    				\draw[line width=1.8ex , color = \colorFour] 
    					(-0.3, 5 ) edge [thick,line width=0.8ex, color = \colorOne ]node [pos=-0.01, left  ]{\huge $107$ } ( 0.3  , 5 )	
    					(-0.3, 0 ) edge [thick,line width=0.8ex,, color = \colorOne ]node [pos=-0.01, below left ]{\huge $0$ } ( 0.3  , 0 )	
    					;			
				\end{scope}
				\draw
    				(1.4, 0.2) edge[line width=1.8ex, color=\colorOne] 
        				node[pos=1.1, below]{ \color{\colorOne}\huge $\theta(s)$} (1.4, -0.2);		
