...
\end{figure}
	...
	Nous voulons extraire une distribution locale de rapidités. Pour cela nous commençons par sélectionner une tranche $[x_0 - \ell/2 , x_0 + \ell/2 [ $ du bord. Puis nous faisons une expansion undimensionnele pendant une durée $\tau$ de 30 ms. Nous avons des données pour $\tau = 1~ms    
