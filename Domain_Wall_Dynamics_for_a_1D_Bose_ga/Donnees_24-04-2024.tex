...
\end{figure}
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        ...
        \caption{{\color{orange}[Orange] Ajustement avec $T = 558.939~\text{nK}$ et $\mu(T = 558.939~\text{nK}, n_p = 56.6~\mu \text{m}^{-1}) = 64.529~\text{nK}$}, {\color{red}[Rouge] Simulation de l'expansion pour $\tau = 0~\text{ms}$, avec $x_0 = 18.339~\mu \text{m}$ et $\ell = 22.176~\mu \text{m}$, ($T = 558.9~\text{nK}$ et $\mu(T = 558.9~\text{nK}, n_p = 56.6~\mu \text{m}^{-1}) = 64.529~\text{nK}$)}.}
