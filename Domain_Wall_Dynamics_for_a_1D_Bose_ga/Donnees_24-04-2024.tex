...
\end{figure}
	...
	La tranche a une dynamique moyenne. Donc  les donnée etais prisent après un temps d'expansion $\tau$ de 1ms, on ne sais pas directement où est le centre  $x_0$ et la taille $\elle$ de la tranche.
