...
Considérons un système intégrable dans un état d’équilibre généralisé (GGE). Comme nous l'avons vu au chapitre~\ref{}, un tel état est décrit par une matrice densité de la forme :
...
Nous avons vu que l'espérance d'une charge généralisée \( \operator{\mathcal{Q}}[f_1] \) dans cet état, notée au chapitre~\ref{} \( \langle \operator{\mathcal{Q}}^{(\mathcal{S})}[f_1] \rangle_{\operator{\rho}_{\mathrm{GGE}}^{(\mathcal{S})}[w]} \), peut être simplifiée, dans ce chapitre, en :
\begin{eqnarray*}
	\langle \operator{\mathcal{Q}}[f_1] \rangle = \mathrm{Tr} \left[ \operator{\rho}_{\mathrm{GGE}}[w]\, \operator{\mathcal{Q}}[f_1] \right]
= \frac{1}{Z[w]}\, \mathrm{Tr} \left[ e^{-\operator{\mathcal{Q}}[w]}\, \operator{\mathcal{Q}}[f_1] \right] =  -  \left . \frac{ \delta \ln Z [w] }{ \delta f_1  } \right|_{w}.	
\end{eqnarray*}
...
\begin{eqnarray*}
	\chi[f_1, f_2] \doteq - \left.\frac{\delta \langle \operator{\mathcal{Q}}[f_1] \rangle}{\delta f_2} \right )_w =  \left . \frac{ \delta^2 \ln Z [w] }{ \delta f_1 \delta f_2 } \right|_{w}= \langle \operator{\mathcal{Q}}[f_1] \operator{\mathcal{Q}}[f_2] \rangle - \langle \operator{\mathcal{Q}}[f_1] \rangle \langle \operator{\mathcal{Q}}[f_2] \rangle .	
\end{eqnarray*}
...
\begin{eqnarray*}
	\left . \frac{\delta \langle \operator{\mathcal{Q}}[f_1] \rangle}{\delta f_2} \right )_w
	= \frac{1}{Z[w]}\, \frac{\delta A[w]}{\delta f_2}
	- \langle \operator{\mathcal{Q}}[f_1] \rangle \cdot \frac{1}{Z[w]}\, \frac{\delta Z[w]}{\delta f_2}.
\end{eqnarray*}
...
\begin{eqnarray*}
	\chi[f_1, f_2]&  \doteq & - \left.\frac{\delta \langle \operator{\mathcal{Q}}[f_1] \rangle}{\delta f_2} \right )_w  \\
&=& -\frac{1}{Z[w]}\, \mathrm{Tr}\left[ \operator{\mathcal{Q}}[w_2]\, e^{-\operator{\mathcal{Q}}[w]}\, \operator{\mathcal{Q}}[f_1] \right]
+ \langle \operator{\mathcal{Q}}[f_1] \rangle \cdot \frac{1}{Z[w]}\, \mathrm{Tr}\left[ \operator{\mathcal{Q}}[f_2]\, e^{-\operator{\mathcal{Q}}[w]} \right] \\
&=& \langle \operator{\mathcal{Q}}[f_2]\, \operator{\mathcal{Q}}[f_1] \rangle - \langle \operator{\mathcal{Q}}[f_1] \rangle\, \langle \operator{\mathcal{Q}}[f_2] \rangle.
\end{eqnarray*}
...
\begin{eqnarray*}
\chi[f_1, f_2] = L^2\iint d\theta\, d\theta'\, f_1(\theta)\, f_2(\theta')\, C(\theta, \theta'),
\end{eqnarray*}
...
\end{eqnarray*}
La matrice $\chi[f_1, f_2]$ s’interprète donc comme la covariance de la densité spectrale projetée sur les fonctions test $w_1$ et $w_2$.

\medskip
Un cas particulier d’intérêt est la susceptibilité d’une seule charge :
\begin{eqnarray*}
\chi[f] \equiv \chi[f, f] = \mathrm{Var}(\operator{\mathcal{Q}}[f]) = \langle \operator{\mathcal{Q}}[f]^2 \rangle - \langle \operator{\mathcal{Q}}[f] \rangle^2
= \iint d\theta\, d\theta'\, f(\theta)\, f(\theta')\, C(\theta, \theta').
\end{eqnarray*}

\section{Passage au régime thermodynamique et rôle de la Hessienne}
...
\begin{itemize}
  ...
  \[
  \chi(\theta, \theta') = \langle \delta \operator{\rho}(\theta)\, \delta \operator{\rho}(\theta') \rangle.
  \]
...
\section{Formalisme gaussien et rôle de la Hessienne}
...
\section{Expression de la Hessienne}
...
% en notant $\langle \rho \rangle = \langle \rho_s \rangle \langle \rho \rangle$.\\
 ...
 \section{Fluctuations autour de la distribution moyenne et inversion de la Hessienne}
