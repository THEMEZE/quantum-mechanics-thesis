...
\subsection*{Principe de fluctuation-réponse dans un état diagonal}
...
\)
avec $A[f] \equiv \mathrm{Tr}[e^{-\operator{\mathcal{Q}}[w]} \operator{\mathcal{Q}}[w_1]]$, on obtient :
\begin{eqnarray*}
...
\(
	\frac{\delta \operator{\mathcal{Q}}[w]}{\delta w_2} = \operator{\mathcal{Q}}[f_2]	.
\)
...
\begin{eqnarray*}
\chi[w_1, w_2] = \iint d\theta\, d\theta'\, w_1(\theta)\, w_2(\theta')\, C(\theta, \theta'),
\end{eqnarray*}
...
\subsection*{Passage au régime thermodynamique}
