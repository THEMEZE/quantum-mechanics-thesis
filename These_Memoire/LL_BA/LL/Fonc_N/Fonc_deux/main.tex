...
\begin{eqnarray}
	\operator{H} \vert {\theta_1, \theta_2} \rangle & = & E \vert {\theta_1, \theta_2} \rangle.
\end{eqnarray}
...
\begin{eqnarray}
	\vert {\theta_1, \theta_2} \rangle & = & \frac{1}{\sqrt{2}}\iint dz_1dz_2 \, \vert z_1 , z_2 \rangle \langle z_1 , z_2  \vert 2  \rangle ~=~\frac{1}{\sqrt{2}} \iint dz_1\,dz_2 \, \varphi_{\{\theta_1 , \theta_2\}}(z_1, z_2) \operator{\Psi}^\dag(z_1) \operator{\Psi}^\dag(z_2) \vert 0 \rangle, \label{chap:1:2.part}
\end{eqnarray}
...
\begin{eqnarray}
	\varphi_{\{\theta_1 , \theta_2\}}(z_1, z_2) & = & 	\langle 0 \vert  \operator{\Psi}(z_1) \operator{\Psi}(z_2)\vert  2  \rangle 
\end{eqnarray}
...
\begin{eqnarray}
	\langle {\theta_1', \theta_2'} \vert {\theta_1, \theta_2} \rangle ~=~ \int dz_1\, dz_2\, \varphi_{\{\theta_1 , \theta_2\}}^\ast(z_1, z_2)\varphi_{\{\theta_1 , \theta_2\}}(z_1, z_2) = \delta_{\theta_1, \theta_1'}\delta_{\theta_2, \theta_2'}.
\end{eqnarray}
...
\begin{eqnarray}
	\operator{H}\vert 1 \rangle &= &  \frac{1}{ \sqrt{2}}  \iint dz_1 dz_2 \,  	\left [ \operator{\mathcal{H}}_2 \varphi_{\{\theta_1 , \theta_2\}}(z_1, z_2) \right ] \, \operator{\Psi}^\dag(z_1) \operator{\Psi}^\dag(z_2) \vert 0 \rangle		
\end{eqnarray}
...
\begin{eqnarray}
	\operator{\mathcal{H}}_2 \varphi_{\{\theta_1 , \theta_2\}}(z_1, z_2) = E \varphi_{\{\theta_1 , \theta_2\}}(z_1, z_2). \label{chap:eq.twobody}
\end{eqnarray}
...
En revenant aux coordonnées d'origine (les coordonnées du laboratoire) , on constate que la fonction d'onde à deux corps $\varphi_{\{\theta_1 , \theta_2\}} (z_1, z_2) = \langle 0 \vert \operator{\Psi} (z_1)\operator{\Psi} (z_2) \vert {\theta_1, \theta_2} \rangle$ satisfait à cette condition :\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Condition de continuité et symétrie de la fonction d’onde et  Forme explicite de la fonction d’onde à deux corps.}
...
\paragraph{Lien entre phase de diffusion et décalage temporel : interprétation semi-classique.}
