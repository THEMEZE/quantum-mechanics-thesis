...
\begin{eqnarray}
	\vert z_1 , z_2 \rangle  ~ = ~  \prod_z\frac{(\operator{\Psi}^\dag(z))^{n_z}}{\sqrt{n_z !}} \vert 0 \rangle ,\quad \vert z_1 \neq z_2 \rangle  ~ = ~  \operator{\Psi}^\dag(z_1) \operator{\Psi}^\dag(z_2)\vert 0 \rangle , \quad \vert z_1 = z_2 \rangle  ~ = ~ \frac{1}{\sqrt{2}} (\operator{\Psi}^\dag(z_1))^2\vert 0 \rangle .
\end{eqnarray}
...
\begin{eqnarray}
	\langle z_1 , z_2 \vert z_1' , z_2' \rangle  ~ = ~ \prod_z\delta_{n_z^{},n_z'}, \quad \langle z_1 < z_2 \vert z_1' < z_2' \rangle  ~ = ~ \delta_{z_1,z_1'}\delta_{z_2,z_2'}, \quad \langle z_1 = z_2 \vert z_1' = z_2' \rangle  ~ = ~ \delta_{z_1,z_1'}.
\end{eqnarray}
...
La fonction d’onde à deux particules est la fonction d’onde symétrique :
...
\begin{eqnarray}
	\varphi_{\{\theta_1 , \theta_2\}}(z_1, z_2) ~ = ~ 	\langle z_1 , z_2   \vert \{\theta_1, \theta_2\} \rangle, \quad \varphi_{\{\theta_1 , \theta_2\}}(z_1, z_2) = \varphi_{\{\theta_1 , \theta_2\}}(z_2, z_1),
\end{eqnarray}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Réécriture de l’Hamiltonien du champ.}
...
\begin{eqnarray}
	\operator{\mathcal{H}}_2 & = &  - \frac{1}{2} \partial_{z_1}^2 - \frac{1}{2} \partial_{z_2}^2+ 	c  \delta(z_1 - z_2). \label{chap:1:hal.mod.2.part.3} 		
\end{eqnarray}
...
\begin{eqnarray}\label{chap:1:hal.mod.2.part.4}
	\operator{\mathcal{H}}_2 & = & 	-\frac{1}{4} \partial_Z^2 - 	\partial_Y^2 + c \delta ( Y ) 
\end{eqnarray}
...
\begin{eqnarray}\label{chap:1:hal.mod.2.part.5}
	- 	\partial_Y^2 \tilde{\varphi}(Y) + c \delta ( Y )\tilde{\varphi}(Y) & = & \tilde{\varepsilon}\tilde{\varphi}(Y) 
\end{eqnarray}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{eqnarray*}
	\underset{ \epsilon \to 0 }{\lim} \int_{-\epsilon}^{+\epsilon}  - 	\partial_Y^2\tilde{\varphi}(Y) + c \delta ( Y )\tilde{\varphi}(Y) \, dY  & = & \underset{ \epsilon \to 0 }{\lim}  \int_{-\epsilon}^{+\epsilon}  \tilde{\varepsilon}(\tilde{\theta})d Y ,\\
	\\
