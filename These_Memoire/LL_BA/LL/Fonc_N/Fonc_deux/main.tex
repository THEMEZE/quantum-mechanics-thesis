...
\begin{eqnarray}
	\vert 2 \rangle & = & \frac{1}{\sqrt{2}}\iint dz_1dz_2 \, \vert z_1 , z_2 \rangle \langle z_1 , z_2  \vert 2  \rangle ~=~\frac{1}{\sqrt{2}} \iint dz_1\,dz_2 \, \varphi_{\{\theta_1 , \theta_2\}}(z_1, z_2) \operator{\Psi}^\dag(z_1) \operator{\Psi}^\dag(z_2) \vert 0 \rangle, \label{chap:1:2.part}
\end{eqnarray}
...
\begin{eqnarray}
	\langle 2 \vert 2 \rangle ~=~ \int dz_1\, dz_2\, |\varphi_{\{\theta_1 , \theta_2\}}(z_1, z_2)|^2 = 1.
\end{eqnarray}
...
En revenant aux coordonnées d'origine (les coordonnées du laboratoire) , on constate que la fonction d'onde à deux corps $\varphi_{\{\theta_1 , \theta_2\}} (z_1, z_2) = \langle 0 \vert \operator{\Psi} (z_1)\operator{\Psi} (z_2) \vert 2 \rangle$ satisfait à cette condition :\\
