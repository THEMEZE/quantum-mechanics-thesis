...
Les mêmes conditions s'appliquent lorsque $x_1$ est échangé avec $x_2$, puisque la fonction d'onde est symétrique. Ainsi, les états propres de l'équation (\ref{chap:eq.twobody}) sont
