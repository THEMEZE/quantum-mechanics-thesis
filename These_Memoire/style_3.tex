...
\documentclass[10pt,titlepage]{book}       %pour un livre
...
% Pour changer la police, on peut utiliser par exemple :
%\usepackage{mathptmx} % Police Times
%\usepackage{palatino} % Autre exemple de police
%\usepackage{libertine} % Libertine, élégante et bien lisible

% Pour une meilleure gestion des caractères et de la langue :
%\usepackage[utf8]{inputenc}
%\usepackage[T1]{fontenc}
%\usepackage[french]{babel} % ou [english] selon la langue du document
...
\usepackage{mdframed} % à inclure dans le préambule
