...
Les fluctuations de \( \rho \) s'écrivent donc :

\begin{eqnarray*}
    \langle\operator{\mathcal{N}}^2 \rangle  &=& L^2 \int d\theta_a \int d\theta_b \, \langle \delta \rho(\theta_a) \delta \rho(\theta_b) \rangle, \\
    \langle (\operator{\mathcal{E}} - \mu \operator{\mathcal{N}})^2 \rangle  &=& L^2 \int d\theta_a \int d\theta_b \, \left( - \mu + \frac{1}{2} m \theta_a^2 \right) \left( - \mu + \frac{1}{2} m \theta_b^2 \right) \langle \delta \rho(\theta_a) \delta \rho(\theta_b) \rangle.
\end{eqnarray*}
