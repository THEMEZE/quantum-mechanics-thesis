...
La distribution de rapidité qui maximise la contribution 
...
Dans cette même section {\em \bf Entropie de Yang-Yang} (\ref{??}), nous avons établi un lien entre \( f \) et \( \rho^c \).\\
