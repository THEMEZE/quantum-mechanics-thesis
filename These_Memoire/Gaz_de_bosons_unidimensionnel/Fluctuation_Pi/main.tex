...
On veux comparer les deux calcule de simulation. On commence par fixer la densité spatial de particule $n$ et on fais fais fluctuer la temperature $T$ et on calcule les fluctuation de densité de rapidité 
...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{Analyse de l'expérience}
	\label{fig:diag_fluct}
\end{figure}
