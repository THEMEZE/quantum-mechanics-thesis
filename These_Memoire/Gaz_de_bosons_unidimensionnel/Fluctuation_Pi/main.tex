...
Dans cette discrétisation, le développement quadratique de l’action \( \mathcal{A}[\rho] \) autour du profil stationnaire \( \rho^c \) s’écrit :
...
\begin{equation*}
    ...
    \mathbf{A}_{\theta_a, \theta_b} \, \delta \rho(\theta_b) \right) }
...
où \( \mathbf{A} \) est la matrice hessienne de l’action évaluée au point stationnaire \( \rho^c \), c’est-à-dire :
...
Cette matrice encode la structure des fluctuations thermiques du système dans l’espace des configurations de rapidité.
