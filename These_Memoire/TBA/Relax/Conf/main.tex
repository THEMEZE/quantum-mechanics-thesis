...
Les variation de $w$ sont négligeables sur $\delta \theta $. Alors on notre l'énergie généralité%  $\sum_{a = 1}^N  f(\theta_a) = \sum_{a \vert tranche } f(\theta_a) \Pi( \theta_a)\delta \theta$.
