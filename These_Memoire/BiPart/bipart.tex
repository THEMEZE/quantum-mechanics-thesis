...
\begin{figure}[H]
	...
	\caption{a) une occupation initiale $\nu( x , \theta ) = \nu_0(\theta)$  correspondant à l'équilibre thermique à la température $T = 560 ~nK$ à une densité spatial linéaire $n_p= 56 ~{\mu m}^{-1}$ et donc à potentielle chimique $\mu = 65~nK$ .}
	\label{fig:grap.A}
\end{figure}
