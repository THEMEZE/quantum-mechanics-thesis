...
\begin{scope}[
  ...
  vanishing point/.style={fill,circle,inner sep=2pt}]
	...
	\drawparallelepiped{-2.5}{-2.5}{-1}{5}{5}{1}{thick, line width=0.1ex,rounded corners = 0.1ex, color=blue , fill = brown,}
	
	
	\drawparallelepiped{-2.25}{-2.25}{0}{0.25}{4.5}{0.25}{thick, line width=0.1ex,rounded corners = 0.1ex, color=black , fill = red,}
	
	\drawparallelepiped{2.25}{2.25}{0}{-0.25}{-4.5}{0.25}{thick, line width=0.1ex,rounded corners = 0.1ex, color=black , fill = red,}
	
	\drawparallelepiped{-1.9}{-2.25}{0}{0.25}{4.5}{0.25}{thick, line width=0.1ex,rounded corners = 0.1ex, color=black , fill = red,}
	
	\drawparallelepiped{1.9}{2.25}{0}{-0.25}{-4.5}{0.25}{thick, line width=0.1ex,rounded corners = 0.1ex, color=black , fill = red,}
	
	
	
	\drawparallelepipedcenter{0}{0}{0}{3}{0.1}{0.1}{thick, line width=0.1ex,rounded corners = 0.1ex, color=red , fill = blue,}
	
	\drawparallelepipedcenter{0}{0.2}{0}{3}{0.1}{0.1}{thick, line width=0.1ex,rounded corners = 0.1ex, color=red , fill = blue,}
