...
\begin{tikzpicture}
    ...
    \begin{scope}
    	...
    	\draw[line width=0.8ex  ,color=\colorFive ,  fill = none] 	
			...
			(-9.5,10) edge[] node[shift = {(0,0)} , pos=1, right ]{\fontsize{20pt}{19pt}\selectfont \bf Profil de bord } (-8,10)
		;
		\draw[line width=1.0ex  ,color=\colorSix ,  fill = none] 	
			plot[] file {data/GHD_bord_article_distribution_24-04-2024.table}
			(-9.5,9) edge[] node[shift = {(0,0)} , pos=1, right ]{\fontsize{20pt}{19pt}\selectfont \bf Ajustement : $T = 560~nK$ } (-8,9)
		;
		\draw[line width=1.0ex  ,color=\colorThree ,  fill = none] 	
			plot[] file {data/GHD_bord_2_article_distribution_24-04-2024.table}
			(-9.5,8) edge[] node[shift = {(0,0)} , pos=1, right ]{\fontsize{20pt}{19pt}\selectfont \bf Selection } (-8,8)
		;
		\draw[line width=0.8ex  ,color=\colorFour ,  fill = none] 
			plot[] file {data/donnee_selection_1_article_distribution_24-04-2024.table}
			(-9.5,7) edge[] node[shift = {(0,0)} , pos=1, right ]{\fontsize{20pt}{19pt}\selectfont \bf $T = 1550~nK$ } (-8,7)
		;
    \end{scope}
