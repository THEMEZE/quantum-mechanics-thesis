...
\newcommand{\backgrowngrid}[8]{
	...
	\begin{scope}[xscale = #5 , yscale = #6 ]
    	...
    	% Paramètres : #1=xmin, #3=xmax, #2=ymin, #4=ymax
   	 	...
   	 	% Grille principale en cm
    	\draw[very thin, line width=0.3ex ,  color=\colorThree] (#1,#2) grid (#3,#4); % Grille de base (1 cm)
    
    	\draw[very thin, line width=0.3ex ,  color=\colorThree] (#1,#2) grid[step=0.1] (#3,#4);
