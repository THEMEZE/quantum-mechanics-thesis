...
\newcommand{\backgrowngrid}[8]{
	...
	\begin{scope}[xscale = #5 , yscale = #6 ]
    	...
    	\clip[decorate, decoration={random steps, segment length=3pt, amplitude=1cm}](8.5,-9) rectangle (13,10);
    	\draw[fill = \colorFour ]  
			(#1 , #2 ) rectangle ( #3 , #4 ) 
		;

   	 	% Grille principale en cm
    	\draw[very thin, line width=0.3ex ,  color=\colorTwo] (#1,#2) grid (#3,#4); % Grille de base (1 cm)
...
\backgrowngrid{-4}{0}{3}{6}{\echelleXCm}{\echelleYCm}{\echelleX}{\echelleY}
