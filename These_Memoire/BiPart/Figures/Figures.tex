...
\begin{tikzpicture}
    ...
    \begin{scope}
    	...
    	\draw[line width=0.8ex  ,color=\colorFour ,  fill = none] 	
			...
			(-10.5,9) edge[] node[shift = {(0,0)} , pos=1, right ]{\fontsize{20pt}{19pt}\selectfont \bf Données } (-9,9)
		;
		\draw[line width=0.8ex  ,color=\colorSix,  fill = none] 	
			plot[smooth] file {data/GHD_1_article_simul_expansion_1_24-04-2024-T-x0.table}
			(-10.5,8) edge[] node[shift = {(0,0)} , pos=1, right ]{\fontsize{20pt}{19pt}\selectfont \bf T = 560 nK  } (-9,8)
		;
		\draw[line width=0.8ex  ,color=\colorThree,  fill = none] 	
			plot[] file {data/GHD_2_article_simul_expansion_1_24-04-2024-T-x0.table}
			(-10.5,7) edge[] node[shift = {(0,0)} , pos=1, right ]{\fontsize{20pt}{19pt}\selectfont \bf Ajust : T = 1550 nK  } (-9,7)
		;
    \end{scope}
	...
	% Axxes 
	\draw[shift = {(-1.2,-1)}](-10, 0) edge[thick, line width=0.8ex, ->, >=Triangle, color=\colorOne] node[shift = {(0,-1)} , pos=0.5, below]{ \huge $x~(\mu m) $ } (10.4, 0);
    \draw [shift = {(-11.2,0)}]  (0, -1) edge[thick, line width=0.8ex, ->, >=Triangle, color=\colorOne] node[shift = {(-1,0)} , pos=0.5, above , rotate = 90 ]{ \huge ${\mu m}^{-1}$ } (0, 11.5)
