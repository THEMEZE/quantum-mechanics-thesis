...
\begin{tikzpicture}
    ...
    \begin{scope}
    	...
    	\draw[line width=1.0ex  ,color=\colorFour ,  fill = none] 	
			plot[color=\colorFour] file {data/donnee_bord_article_distribution_24-04-2024.table};
		\draw[line width=1.0ex  ,color=\colorFour ,  fill = none] 	
			plot[color=\colorFour] file {data/GHD_bord_article_distribution_24-04-2024.table};
		\draw[line width=1.0ex  ,color=\colorFour ,  fill = none] 	
			plot[color=\colorFour] file {data/GHD_bord_2_article_distribution_24-04-2024.table};
		\draw[line width=1.0ex  ,color=\colorSix ,  fill = none] 
			plot[color=\colorSix] file {data/donnee_selection_1_article_distribution_24-04-2024.table}
		;
    \end{scope}
