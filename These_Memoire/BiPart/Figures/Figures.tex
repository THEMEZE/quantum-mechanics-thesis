...
\begin{tikzpicture}
    ...
    \begin{scope}
    	...
    	\draw[line width=0.8ex  ,color=\colorFour ,  fill = none] 	
			...
			(-10,9) edge[] node[shift = {(0,0)} , pos=1, right ]{\fontsize{15pt}{19pt}\selectfont \bf Données } (-8.5,9)
		;
		\draw[line width=0.8ex  ,color=\colorSix,  fill = none] 	
			plot[smooth] file {data/GHD_1_article_simul_expansion_1_24-04-2024-T-x0.table}
			(-10,8) edge[] node[shift = {(0,0)} , pos=1, right ]{\fontsize{15pt}{19pt}\selectfont \bf T = 560 nK  } (-8.5,8)
		;
		\draw[line width=0.8ex  ,color=\colorThree,  fill = none] 	
			plot[] file {data/GHD_2_article_simul_expansion_1_24-04-2024-T-x0.table}
			(-10,7) edge[] node[shift = {(0,0)} , pos=1, right ]{\fontsize{15pt}{19pt}\selectfont \bf Ajust : T = 1550 nK  } (-8.5,7)
		;
    \end{scope}
