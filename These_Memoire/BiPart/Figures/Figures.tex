...
\newcommand{\GraduationYCm}[4]{% #1: min, #2: max, #3: liste
  ...
  \GraduationYMm{\extendedPosition}{\echelle}
}
...
\newcommand{\GraduationXCm}[4]{% #1: min, #2: max, #3: liste
  ...
  \pgfmathparse{#2 + 1}
  \edef\extendedPosition{\pgfmathresult}
  \GraduationXMm{\extendedPosition}{\echelle}
}
...
\def\listeLabelsY{{-2,"-un", "zero", "un", "deux", "trois", "quatre"}}

% Appel de la commande
\begin{scope}
\clip (-11 , -3) rectangle (11 , 5) ;
\GraduationYCm{-2}{4}{\listeLabelsY}{\echelleY}
...
% Définition de la liste
\def\listeLabelsX{{-2,"-un", "zero", "un", "deux", "trois", "quatre"}}

% Appel de la commande
\begin{scope}
%\clip (-11 , -3) rectangle (11 , 5) ;
\GraduationXCm{-2}{4}{\listeLabelsX}{\echelleX}
%\drawgrid{-11}{15}{-11}{11}
%\draw[line width=2.5ex , color = red ] (-11 , -3) rectangle (11 , 5) ;
%\path (-11 , -3) rectangle (11 , 5);	
\end{scope}
