...
\begin{tikzpicture}
    ...
    \begin{scope}
    	...
    	\draw[line width=1.0ex  ,color=\colorFive ,  fill = none] 	
			...
			(-9,10) edge[] node[shift = {(0,0)} , pos=1, right ]{\fontsize{16pt}{19pt}\selectfont Profil de bord } (-8,10)
		;
		\draw[line width=1.0ex  ,color=\colorSix ,  fill = none] 	
			plot[] file {data/GHD_bord_article_distribution_24-04-2024.table}
			(-9,9) edge[] node[shift = {(0,0)} , pos=1, right ]{\fontsize{16pt}{19pt}\selectfont Ajustement : $T = 560~nK$ } (-8,9)
		;
		\draw[line width=1.0ex  ,color=\colorThree ,  fill = none] 	
			plot[] file {data/GHD_bord_2_article_distribution_24-04-2024.table}
			(-9,8) edge[] node[shift = {(0,0)} , pos=1, right ]{\fontsize{16pt}{19pt}\selectfont Ajustement : $T = 560~nK$ } (-8,8)
		;
