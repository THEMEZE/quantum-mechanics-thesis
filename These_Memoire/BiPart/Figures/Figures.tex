...
\begin{tikzpicture}
	...
	\foreach \R  in { 1 ,... , 4  } {
		...
		\foreach \r in { 1 ,... , 9   } {
			\draw ( {-0.25 * 0.5 * (cos(3.14*0.2*\r r)^2 + 1)}    , \R*\echelle - \echelle  +  0.1*\echelle *\r ) edge [thick,line width=0.3ex , color = gray  ] ({0.25 * 0.5 * (cos(3.14*0.2*\r r)^2 + 1)} ,\R*\echelle - \echelle +  0.1*\echelle *\r  );
		}
	}
