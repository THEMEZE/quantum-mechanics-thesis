...
\newcommand{\backgrowngrid}[6]{
	...
	\begin{scope}[]
    	...
    	\foreach \x in {#1,..., #3} {
        	\draw[shift={(\x, #2)}] (0,-0.1) edge[line width=0.8ex] node[pos = -1 , below] {\x} (0,0.1); % Lignes verticales en mm
    	}
...
\GraduationYCm{0}{6}{\listeLabelsY}{\echelleY}
...
\begin{scope}
%\clip (-11 , -3) rectangle (11 , 5) ;
\GraduationXCm{-4}{3}{\listeLabelsX}{\echelleX}
%\drawgrid{-11}{15}{-11}{11}
%\draw[line width=2.5ex , color = red ] (-11 , -3) rectangle (11 , 5) ;
%\path (-11 , -3) rectangle (11 , 5);	
\end{scope}
