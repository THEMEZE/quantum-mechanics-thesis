...
\begin{tikzpicture}
    ...
    \begin{scope}
    	...
    	\draw[shift = {(-10 cm ,5 cm)} , line width=2.5ex , color = \colorThree , fill = \colorThree!50!\colorTwo, rounded corners =6pt, inner sep=6pt] (0 , 0) rectangle (5 , 5) ;
    	\draw[line width=1.0ex  ,color=\colorFive ,  fill = none] 	
			plot[] file {data/donnee_bord_article_distribution_24-04-2024.table}
			(-9,10) edge[] 
        node[shift = {(0,0)} , pos=1, right ]{\fontsize{16pt}{19pt}\selectfont Profil de bord } (-8,10)
		;
