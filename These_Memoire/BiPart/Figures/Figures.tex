...
\newcommand{\backgrowngrid}[6]{
	...
	\begin{scope}[xscale = #5 , yscale = #6 ]
    	...
    	%\draw[fill = \colorFour , opacity = 0.4]  (#1 , #2 ) rectangle ( #3 , #4 ) ;
...
\begin{tikzpicture}
    ...
    \draw[fill = \colorFour , opacity = 0.4]  (\valXmin , 0 ) rectangle (9.5 , 12) ;
	...
	\draw[line width=0.1ex , color = \colorFour , fill = none] 	
		...
		(\valXmin, 0) edge[thick, line width=0.8ex, ->, >=Triangle, color=\colorThree] 
