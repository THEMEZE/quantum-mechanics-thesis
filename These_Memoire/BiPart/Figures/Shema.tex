...
\newcommand{\CoupureDeuxZeroDiagram}[0]{
	...
	\draw[opacity = 0.3 , dashed , dash pattern=on 6pt off 3pt, line width=0.5ex , color = \colorTwo , fill = none] 
		...
		(-7,7) edge []node [pos=1.1, right ]{\huge $bord~v^{\mbox{\tiny{eff}}}$ } ( -6.5  , 7 )	 
	;
	\draw[opacity = 0.5 , dotted , dash pattern=on 0pt off 2pt, line width=0.5ex , color = \colorTwo , fill = none] 
		plot[smooth] file {data/bord_1_0.table}
		(-7,6) edge []node [pos=1.1, right ]{\huge $bord~gauche$ } ( -6.5  , 6 )	 
	;
	\draw[opacity = 0.5 , dash dot , dash pattern=on 8pt off 2pt on 0pt off 2pt, line width=0.5ex , color = \colorTwo , fill = none] 
