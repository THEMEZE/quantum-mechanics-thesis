		...
		\begin{tikzpicture}[transform canvas={scale=1}] 
			...
			\draw
    			(0.45, 0.2) edge[line width=1.8ex, color=\colorTwo] 
        						node[pos=1.0, below]{ \color{\colorTwo}\huge $x_b(s)/t$} (0.45, -0.2)
        		(0.2 , 1.45 ) edge[line width=1.8ex, color=\colorTwo] 
        						node[pos=1.1, left ]{ \color{\colorTwo}\huge $\theta_b(s)$} (-0.2 , 1.45 )
	...
	\begin{scope}
        ...
        \draw
    		(0.45, 0.2) edge[line width=1.8ex, color=\colorOne] 
        						node[pos=1.0, below]{ \color{\colorOne}\huge $x_b(s)/t$} (0.45, -0.2)
...
\newcommand{\CoupureDeuxZeroDiagram}[0]{
	...
	\node at (0,0) [circle, ] {
		\begin{tikzpicture}[transform canvas={scale=1}] 
			...
			\draw
    			(0.45, 0.2) edge[line width=1.8ex, color=\colorTwo] 
        						node[pos=1.1, below]{ \color{\colorTwo}\huge $x_b(s)$} (0.45, -0.2)
        		(0.2 , 1.4 ) edge[line width=1.8ex, color=\colorTwo] 
        						node[pos=1.1, left ]{ \color{\colorTwo}\huge $\theta_g(s)$} (-0.2 , 1.4 )
...
\newcommand{\CoupureDeuxZeroDensity}[0]{
	...
	\draw 
		(-8,4) edge [thick,line width=1.8ex,opacity = 0.6 , dashed , color = \colorThree ]node [pos=1.1, right ]{\huge $\tilde{n}( \tau = 0^{-})$ } ( -7.5  , 4 )	
...
\newcommand{\CoupureDeuxZeroDistribution}[0]{
	...
	\draw
    	(1.4, 0.2) edge[line width=1.8ex, color=\colorThree] 
        				node[pos=1.1, below]{ \color{\colorThree}\huge $\theta_g(s)$} (1.4, -0.2);
		...
		\begin{tikzpicture}[transform canvas={scale=1}] 
			...
			\draw
    			(1.9, 0.2) edge[line width=1.8ex, color=\colorTwo] 
        						node[pos=1.1, below]{ \color{\colorTwo}\huge $x_b(s)/\tau$} (1.9, -0.2)
                (1.9 , -0.2 ) edge[line width=0.8ex, color=\colorTwo , dashed ] (1.9 , 2 )
        		(0.2 , 1.3 ) edge[line width=1.8ex, color=\colorTwo]
        						node[pos=1.1, left ]{ \color{\colorTwo}\huge $\theta_g(s)$} (-0.2 , 1.3 )
        		(-0.2 , 1.3 )  edge[line width=0.8ex, color=\colorTwo , dashed ] (3.5  , 1.3 )
                (0.2 , 0.45 ) edge[line width=1.8ex, color=\colorTwo]
                                node[pos=1.1, left ]{ \color{\colorTwo}\huge $\theta_d(s)$} (-0.2 , 0.45 )
                (-0.2 , 0.45 )  edge[line width=0.8ex, color=\colorTwo , dashed ] (3.5  ,0.45 )
        	;
		\end{tikzpicture}};
	\draw[opacity = 0.5 , dotted ,dash pattern=on 2pt off 2pt, line width=0.5ex , color = \colorTwo , fill = none] 
...
\newcommand{\CoupureDeuxExpDensity}[0]{	
	...
	\Axesdensity[$x/\tau ~ ( \mu m / ms ) $]{$\tilde{n}*\tau ~( m s / \mu m )$}
