...
\begin{tikzpicture}[scale=1]
    \DiagramDensityDistribution{\InsitutDiagram}{\InsitutDensity}{\InsitutDistribution}{\Vide}
    %abcd
    \node at (-8,8) [circle]{\color{\colorTwo} a)};
	\node at (-8,19) [circle]{\color{\colorOne} b)};
	\node at (-19,8) [circle]{\color{\colorOne} c)};
...
\begin{tikzpicture}[scale=1]
	...
	\begin{scope}[shift={(43cm,0)}]
		\node at (-8,8) [circle]{\color{\colorTwo} e)};
		\node at (-8,19) [circle]{\color{\colorOne} f)};
		\node at (-19,8) [circle]{\color{\colorOne} g)};	
	\end{scope}
...
\begin{tikzpicture}[scale=1]
	...
	\node at (-8,19) [circle]{\color{\colorOne}\huge b)};
	\node at (-19,8) [circle]{\color{\colorOne} c)};
	\node at (19,8) [circle]{\color{\colorOne} d)};
	\begin{scope}[shift={(43cm,0)}]
		\node at (-8,8) [circle]{\color{\colorTwo} e)};
